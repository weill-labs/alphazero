# Vendored verbatim from pgx examples/alphazero/network.py (Apache-2.0):
# https://github.com/sotetsuk/pgx/blob/main/examples/alphazero/network.py
# Kept identical so the spike measures the same workload as the official
# pgx AlphaZero example. Only used for inference-throughput timing here.
